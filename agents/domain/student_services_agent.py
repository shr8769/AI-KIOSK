...
class StudentServicesAgent(BaseAgent):
    """
    Agent handling student services-related queries using ChromaDB.
    """
    def __init__(self, client: Any = None, db_path: str = None):
        """
        Initializes the StudentServicesAgent.
        ...
        """
        super().__init__(collection_name="student_services", client=client, db_path=db_path)
...
if __name__ == "__main__":
    print("====================================")
    print("Student Services Agent Ready")
